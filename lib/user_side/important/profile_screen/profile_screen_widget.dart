                      ...
                      children: [
                        Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_SCREEN_PAGE_Row_b0evcdxx_ON_TAP');
                      ...
                      children: [
                        Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROFILE_SCREEN_PAGE_Row_osgrhona_ON_TAP');
                                ...
                                builder: (context) {
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: AboutAppBottomSheetWidget(),
                                    ),
                                  );
                                },
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'PROFILE_SCREEN_PAGE_GO_BACK_BTN_ON_TAP');
                      ...
                      options: FFButtonOptions(
                        ...
                        textStyle:
                            FlutterFlowTheme.of(context).bodySmall.override(
                                  ...
                                  color: FlutterFlowTheme.of(context).text100,
                                  fontSize: 14,
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'PROFILE_SCREEN_DELETE_USER_BTN_ON_TAP');
                        ...
                        var confirmDialogResponse = await showDialog<bool>(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      'Are you sure you want to delete your account? Data won\'t be saved.'),
                                  actions: [
                                    TextButton(
