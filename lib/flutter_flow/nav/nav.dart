...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : OnboardingScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => AddProductWidget(
            imageupdated: params.getParam('imageupdated', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'productAdded',
        ...
        FFRoute(
          ...
          builder: (context, params) => ItemDescrWidget(
            productRef: params.getParam(
                'productRef', ParamType.DocumentReference, false, ['Items']),
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/MysticBlend_(1).png',
                      width: 300.0,
                      fit: BoxFit.contain,
                    ),
                  ),
