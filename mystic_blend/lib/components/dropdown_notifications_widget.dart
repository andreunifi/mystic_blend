...
class DropdownNotificationsWidget extends StatefulWidget {
  const DropdownNotificationsWidget({
    Key? key,
    required this.user,
    required this.chats,
  }) : super(key: key);
...
class _DropdownNotificationsWidgetState
    extends State<DropdownNotificationsWidget> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'DROPDOWN_NOTIFICATIONS_close_rounded_ICN');
                        logFirebaseEvent(
                ...
                child: Column(
                  ...
                  children: [
                    Builder(
                      builder: (context) {
                        final messages =
                            widget.chats!.toList().take(3).toList();
