...
class _AuthScreenWidgetState extends State<AuthScreenWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'authScreen'});
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'AUTH_SCREEN_PAGE_LOGIN_BTN_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Button_auth');
                                                  GoRouter.of(context)
                                                      .prepareAuthEvent();
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'AUTH_SCREEN_FORGOT_PASSWORD?_BTN_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Button_auth');
                                                  if (_model
                                                      .emailAddressController
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'fcasosvv' /* Or login as a guest (Limited f... */,
                                                      ),
                                                      textAlign:
                                                          TextAlign.center,
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'AUTH_SCREEN_LOGIN_AS_A_GUEST_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_auth');
                                                            GoRouter.of(context)
                                                                .prepareAuthEvent();
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'AUTH_SCREEN_SELECT_BIRTHDAY_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '1oczvfqq' /* Cellphone and Birthday are opt... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: FlutterFlowTheme
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'ggbef8ve' /* I've read and i accept the */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: FlutterFlowTheme
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Builder(
                                                        builder: (context) =>
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'AUTH_SCREEN_PAGE_Text_lq59trax_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Text_alert_dialog');
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'AUTH_SCREEN_CREATE_ACCOUNT_BTN_ON_TAP');
                                                      logFirebaseEvent(
